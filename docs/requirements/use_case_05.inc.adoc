...
== Use-Case: UC05 Teams generieren

=== Kurzbeschreibung
Der Use Case beschreibt den Prozess der Generierung der Teams auf Grundlage der ausgefüllten Formulare der Studierenden.
...
* Alle Studierende haben ein Formular ausgefüllt.
