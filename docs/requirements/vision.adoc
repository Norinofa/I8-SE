...
[cols="1,3"]
|===
| Das Problem | bisheriges Online-Tool erfüllt zwar den gewünschten Zweck der Teamgenerierung, jedoch ist die Handhabung und die Oberfläche in vielen Bereichen nicht ausgereift, außerdem fehlen Informationen im Fragebogen
| betrifft | die Studierenden und Dozenten des Moduls Software Engineering, sowie den Kunden Herrn Zirkelbach
