...
| Überarbeitung bzw. Neugestaltung der Oberfläche | xx | schlanke, funktionale Oberfläche, einfachere Menüführung für Studenten- und Dozentenansicht, bessere Ausnutzung des Platzes, Labels/Begriffe vereinheitlichen und von den Begrifflichkeiten (ein-/mehrzahl, genderge­ rechte Begriffe) anpassen,  | xx
