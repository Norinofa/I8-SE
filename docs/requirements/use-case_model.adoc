...
Da wir eine Neuentwicklung mitten im Semester beschlossen haben, weil das alte System nicht mehr tragbar war. Waren wieder alle Use Cases wieder relevant für uns. Jedoch konnten wir nicht alle Use Cases erfolgreich erledigen, da wir nicht mehr die nötige Zeit hatten. Beispielsweise konnten wir den UC07 nicht mehr bearbeiten.
