...
Auf diesem Diagramm entspricht die Reihenfolge nicht der Priorisierung der Use Cases. Die Priorisierung ist dem Überschrift "Identifizierte Use Cases" zu entnehmen.
