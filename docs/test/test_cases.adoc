...
*Testablauf 1: Fehlerfreie Beispieleingabe*

* Meldung über erfolgreiche Speicherung
* Daten werden in der Datenbank erfasst


*Testablauf 2: Fehlerhafte Beispieleingabe mit erneut gewählter ID*
...
*Testablauf 3: Fehlerhafte Beispieleingabe mit leerem Pflichtfeld*
