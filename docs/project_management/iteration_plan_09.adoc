...
| Beginn der Iteration | 23.04.23
| Treffen mit Coach | 04.05.23
| Ende der Iteration | 07.05.23
|===


== Wesentliche Ziele

* Datenbank mit bisherigen Code verbinden
* klären, wie mit dem Login weiterverfahren werden soll (SSL beantragen)
* Mit den Dokumentationen vertraut machen, kontinuierlich (stichpunktartig) Fortschritte aufschreiben
