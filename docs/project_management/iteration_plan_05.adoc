...
* _Ziel 6_ wurde größtenteils erreicht. Durch die verspätete Kontrollierung auf Sinnhaftigkeit und wenig Kommunikation mit dem Auftraggeber unserer Seits, besteht die Chance auf mangelnde Kenntnisse und demzufolge fehlerhafte Vervollständigung des Architecture Notebooks.
