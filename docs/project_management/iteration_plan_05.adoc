= Iteration Plan 05: I8 Erstellung und Verwaltung von Gruppen für Software Engineering Projekte
...
* Use Cases beenden und das Dokument verfeinern
* auf Iterationspläne einigen und verfeinern
* Projektplan beenden
* Architecture Notebook zu Ende bringen 
* Test Cases ausarbeiten und beenden
* die Belegabgabe auf Vollständigkeit, Sinnhaftigkeit und Rechschreibung prüfen
...
* Alle abzugebenen Dokumente sind vollständig, sinnvoll und grammatikalisch so wie von der Rechtschreibung korrekt
