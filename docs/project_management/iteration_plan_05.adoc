...
| rot
| 
* Das Architecture Notebook weist Lücken und Formatierungsprobleme auf. Die Formatierungsprobleme entstehen worwiegend durch das Einfügen des Dokumentes in Word. Hier muss verschärft darauf geachtet werden, dass das Dokument, direkt nach dem Einfügen in GitHub, nach Angaben von Asciidoc formatiert wird.
...
* Die Test Cases sind vollständig ausgearbeitet.
...
* _Ziel 3_ wurde erreicht. Der Auftraggeber hat das Use Case Model für den derzeitigen Stand als richtig erachtet, jedoch angemerkt, dass sich die Prisosierung der Use Cases im Verlauf des Projektes ändern kann.
