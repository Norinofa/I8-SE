...
| Termin mit Coach/ (Auftraggeber)| 20.12.22
...
* der Coach/ Auftraggeber ist mit den ausgearbeiteten Use Cases einverstanden
...
* Der Coach war mit der Ausarbeitung der Use Cases nicht ganz einverstanden, da viele identifizierte Use Cases bereits in der uns gegebenen Vorlage beinhaltet sind
