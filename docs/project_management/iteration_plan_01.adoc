...
Die in dieser Iteration geplanten Aufgaben sind in der Work Items List dargestellt (s. Workitems_list).
...
| wenig Kommunikation | x | anderen Weg zur Kommunikation finden?
|===
...
* Vision erstellen, die die Kundenwünsche berücksichtigt und machbar ist
* logische Use Cases finden
* Iterationsplan, an dem man sich orientieren kann erstellen
...
[%header, cols="1,3"]
|===
| Assessment Ziel | Iteration 01

| Assessment Datum | 12.12.2022
| Teilnehmer | Evelyn
| Projektstatus	| gelb
|===
...
Die Aufgaben wurden zum großen Teil angefangen, jedoch noch nicht erledigt.
...
Vision und Use Cases müssen noch beendet werdet
