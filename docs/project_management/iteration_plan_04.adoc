...
* _Ziel 7:_ Die Test Cases wurden verschoben und werden in der Iteration 05 angefangen und zu Ende gebracht.
...
* _Ziel 1:_ Der Prototyp wurde in der Präsentation am 16.01.23 vorgestellt. Die Korrektheit des Prototypen an sich wurde umkommentiert gelassen, jedoch wurde die Neuimplementierung, statt der Weiterentwicklung, thematisiert. Es wurde klargestellt, dass die uns gegebene Webseite nicht funktioniert und daher auf die Notlösung zurückgegriffen wurde. 

* _Ziel 3 und 4:_ wurden nicht erreicht, da die Ausarbeitung nur zur 10% erfolgte. Sie wurden bisher nur sporadisch begonnen und es bedarf nooch einem erhöhten Arbeitsaufdaher entsprechen sie nicht den Bewertungskriterien
* _Ziel 6:_ Wireframes, Use Case Model und Use Cases wurden vom Auftraggeber als ausbaufähig wahrgenommen. Die Prisorisierung des Use Cases 'Projekte verwalten' wurde als sehr hoch eingeschätzt und soll stärker vertieft werden.  Die Verbesserungswünsche wurden im restlichen Verlauf der Iteration 04 bestmöglich umgesetzt. Diese werden dem Auftraggeber in Iteration 05 präsentiert.
