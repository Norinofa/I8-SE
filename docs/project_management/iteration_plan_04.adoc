...
* _Ziel 3 und 4:_ Das Domänenmodell und das Glosssar wurden bisher nur sporadisch begonnen und daher zur Fertigstellung in die Iteration 05 verschoben.
...
* _Ziel 6:_ Wireframes, Use Case Model und Use Cases wurden vom Auftraggeber als ausbaufähig wahrgenommen und die Verbesserungswünsche wurden im restlichen Verlauf der Iteration 04 bestmöglich umgesetzt. Diese werden dem Auftraggeber in Iterion 05 präsentiert.
