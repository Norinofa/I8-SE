...
* _Ziel 7:_ Die Test Cases wurden verschoben, da erstmal die Verbsserungswünsche des Auftraggebers bezüglich der Use Cases in Angriff genommen wurde. Daher werden diese verschoben und in der Iteration 05 angefangen und zu Ende gebracht.
...
* _Ziel 6:_ Wireframes, Use Case Model und Use Cases wurden vom Auftraggeber als ausbaufähig wahrgenommen. Die Prisorisierung des Use Cases 'Projekte verwalten' wurde im Meeting vom Auftraggeber als sehr hoch eingeschätzt und soll stärker vertieft werden.  Die Verbesserungswünsche wurden im restlichen Verlauf der Iteration 04 bestmöglich umgesetzt. Diese werden dem Auftraggeber in Iteration 05 präsentiert.
