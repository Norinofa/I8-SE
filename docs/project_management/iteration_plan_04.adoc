...
* Das Domänenmodell und das Glosssar wurden bisher nur sporadisch begonnen.
* Die Test Cases wudern verschoben und werden in der Iteration 05 angefangen und zu Ende gebracht.
