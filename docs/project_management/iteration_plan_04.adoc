...
"Ziel 1" wurde erreicht. Der Prototyp wurde erstellt und am 16.01.23 vorgestellt. 
"Ziel 2" wurde erreicht. Die Systemweiten Anforderungen wurden beendet. 
"Ziel 3 und 4" wurden nicht erreicht. 
"Ziel 5" wurde erreicht. 
"Ziel 6" wurde nicht erreicht. 



* Das Domänenmodell und das Glosssar wurden bisher nur sporadisch begonnen. Die Test Cases werden in der Iteration 05 angefangen und zu Ende gebracht.
...
* Wireframes, Use Case Model und Use Cases wurden vom Auftraggeber als ausbaufähig wahrgenommen und die Verbesserungswünsche wurden im restlichen Verlauf der Iteration 04 bestmöglich umgesetzt.
* Die Implementierung wurde in der Präsentation vorgestellt und soweit unbewertet gelassen.
