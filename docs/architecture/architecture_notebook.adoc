...
Die Architektur muss eine Webanwendung für Studierenden und Professoren, welche es ermöglicht Teams mit der gleichen Anzahl der Studierenden jedoch unterschiedlicher Rollen in verschiedenen Projekten aufzuteilen, verwirklichen. Diese basiert ursprünglich auf einer bereits bestehenden Anwendung, wird jedoch als Neuentwicklung angesetzt und übernimmt den grundlegenden Inhalt der Vorgängerstruktur. Unsere Schwerpunkte bei der Architektur der Weiterentwicklung liegen auf der Nutzerfreundlichkeit für Studierenden, sowie Projektadministrator und der Anpassung der Programmiersprache und Erweiterung des bereits vorhandenen Algorithmus.

Weitere Ziele, die die Architektur in Bezug auf Struktur und Verhalten
erreichen soll, sind:

* Login für Studierende und Dozenten
...
* Jeder Student besitzt einen HTW-Login.

* Für Studenten herrscht eine Einschreibung im Modul Software Engineering I vor.

* Es herrscht eine stabile Verbindung zum Internet vor.


//* Die Neuentwicklung auf Basis eines bestehenden Systems

//* Ein System zur Erstellung und Verwaltung von Gruppen in Software Engineering Projekten und des Fragebogens der Studierenden.

//* Java ist als Programmiersprache für das Backend zu verwenden.

//* Das Framework für das Backend ist Java Spring.
...
* Um faire Teams erstellen zu können, soll der Dozent die Möglichkeit haben, durch ein Eingabefeld festzulegen wie viele Personen mindestens in einem Team sein müssen. Hierfür muss der Algorithmus mit einer variablen Anzahl an Teams arbeiten können. 
...
.. Datenbanken basierend auf MySQl, da die es eine breite Anwendung hat und gut dokumentiert ist

.. Konfiguration über Docker

. Neue Entscheidungen:

.. Als Backend benutzen wir Java, da die Programmiersprache für unsere Kenntisse besser geeignet ist

.. Als Framework Spring Boot, da Sping Boot passend zur Programmiersprache Java agiert

.. Als Frontend benutzen wir Java Script und CSS, ebenfalls wegen der Kompatibilität 
