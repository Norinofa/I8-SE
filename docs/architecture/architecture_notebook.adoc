...
Zeigt die Projekte mit der wesentlichen Beschreibung und deren Ansprechpartner. Sortiert sind die Projekte nach ihrer ID welche vom Dozenten manuell vergeben wird. Abgebildet wird sie für den Dozenten, aber auch oberhalb des Fragebogens ist sie für die Studenten einsehbar.
...
In der Rolle des Besuchers. Von ihm werden auf der Studentenansicht
