...
Gearbeitet wird hier mit Container, dies gibt uns die Möglichkeit das jeder einzelne Komponente 
in ihrem eigenen Prozess laufen kann. Bezeichnen kann man diese Container als virtuelle Knoten, 
die mit einander kommunizieren. Django kommuniziert mit der Datenbank und der Webserver mit der Django. 
