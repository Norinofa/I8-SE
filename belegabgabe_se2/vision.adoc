...
* Hard gecodeter Code der Vorgänger
* andere Expertise als die Vorgänger
...
| Neugestaltung der Oberfläche | Hoch | schlanke, funktionale Oberfläche, einfachere Menüführung für Studierenden- und Dozentenansicht, bessere Ausnutzung des Platzes der Website, Labels/Begriffe vereinheitlichen und von den Begrifflichkeiten (Ein-/ Mehrzahl, gendergerechte Begriffe) anpassen  | xx
